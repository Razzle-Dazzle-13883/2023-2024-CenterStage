...
public class Red extends LinearOpMode {
    ...
    public void redMiddleFar() {
        ...
        drive(-18 * TICKS_PER_INCH, -18 * TICKS_PER_INCH, 18 * TICKS_PER_INCH, 18 * TICKS_PER_INCH, 0.5);
        sleep(500);
        drive( -90 * TICKS_PER_INCH, -90 * TICKS_PER_INCH, -85 * TICKS_PER_INCH, -85 * TICKS_PER_INCH, 0.5);
        sleep(2000);
    ...
    public void redLeftFar() {

    }

    public void redRightFar() {
